...
#include <iostream>
Punkt2::Punkt2() {
	std::cout << endl << "Objekt zosta� utworzony konstruktorem domy�lnym" << endl;
	x = 0.0;
	y = 0.0;
}
...
Punkt2::Punkt2(double _x, double _y) {
	std::cout << endl << "Objekt zosta� utworzony konstruktorem tworz�cym z dw�ch argument�w" << endl;
	x = _x;
	y = _y;
}
...
Punkt2::Punkt2(Punkt2 &&p){
	std::cout << endl << "Objekt zosta� utworzony konstruktorem przenoszącym" << endl;
	x = p.x;
	y = p.y;
	p.x = 0;
	p.y = 0;
